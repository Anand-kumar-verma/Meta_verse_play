...
import WelcomeBonus from "../pages/income/incomeSubSection/WelcomeBonus.js";
import GiftBonus from "../pages/income/incomeSubSection/GiftBonus.js";
import InvitationBonusFn from "../pages/income/incomeSubSection/InvitationBonus.js";
import ReferralFirstRechargeSalary from "../pages/income/incomeSubSection/RefferralFirstRecharge.js";
...
export const routes = [
  ...
  {
    path: "/account/income-main/refferralfirstrecharge-bonus",
    component: <ReferralFirstRechargeSalary />,
  },
  ...
  {
    path: "/account/income-main/invitation-bonus",
    component: <InvitationBonusFn />,
  },
  {
    path: "/account",
    component: <Account />,
  ...
  {
    path: "/account/income-main/gift-bonus",
    component: <GiftBonus />,
  },
  {
