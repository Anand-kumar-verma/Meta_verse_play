export const rupees = "₹";
export const baseUrl = "https://admin.metaverseplay.vip";
export const fron_end_main_domain = "https://metaverseplay.vip";
export const newdomain = "https://api.metaverseplay.vip";
export const dummy_aviator = "https://metaverse-timer.onrender.com";
...
export const endpoint = {
  ...
  refferralrecahrge_income: `${newdomain}/api/v1/get-direct-first-recharge-bonus`,
