...
import { ReferralfirstRechargeBonusFn } from "../../../services/apicalling";

function ReferralFirstRechargeSalary() {
      ...
      <Layout>
        ...
        >
          <Box sx={style.header}>
            ...
            <p>Referral First Recharge Salary Bonus</p>
          </Box>
          <div>
    ...
    <Layout header={false}>
      ...
      >
        ...
        <div className="!overflow-x-auto" style={{ width: "95%", marginLeft: '2.5%', marginTop: '16px', }}>
          <Table sx={{ background: zubgback, boxShadow: zubgshadow }}>
            <TableHead>
              <TableRow >
...
export default ReferralFirstRechargeSalary;
